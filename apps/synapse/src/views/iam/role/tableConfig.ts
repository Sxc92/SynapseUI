 ...
 */
export const gridConfig: Partial<VxeGridProps<RoleData>> = {
  ...
  schema: [
    {
      ...
      componentProps: {
        allowClear: true,
        placeholder: $t('role.searchCodePlaceholder'),
      },
      fieldName: 'code',
      label: $t('role.code'),
    },
    {
      ...
      componentProps: {
        allowClear: true,
        placeholder: $t('role.searchDescriptionPlaceholder'),
      },
